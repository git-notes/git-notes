...
module.exports = (grunt) ->
  ...
  ciTasks = ['output-disk-space', 'download-electron', 'download-atom-shell-chromedriver', 'build']
  ...
  defaultTasks = ['download-electron', 'download-atom-shell-chromedriver', 'build', 'set-version', 'generate-asar']
